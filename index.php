...
<div class="blog">
  <div class="container">
    ...
    <div class="row">
      <?php
      $query ="select * from category where rest_id = {$_SESSION['rest_id']}";
      ...
      while($row  = mysqli_fetch_assoc($result)){ 
       ...
       echo "<a href='products-grid.php?cat_id={$row['cat_id']}'>
       		   <figure>
       		      <img src='admin/images/category/{$row['cat_image']}' width='348' height='232'/>
               </figure>
             </a>
          </div>";	
       echo "<h3>{$row['cat_name']}</h3></div></div>";
      }?>
